    ...
    <Teleport to="body">
      <div class="overlay" v-if="resultVisible" @click.self="resultVisible = false">
        <div class="result-dialog">
          ...
          <h2>取款成功</h2>
          <div class="rd-table">
            <div class="rd-row"><span>本次取款</span><strong class="debit">-{{ result.transAmount }}</strong></div>
            <div class="rd-row"><span>取款后余额</span><strong>{{ result.balanceAfter }}</strong></div>
          </div>
...
.rd-row strong.debit { color: #f97316; }
.rd-btn {
